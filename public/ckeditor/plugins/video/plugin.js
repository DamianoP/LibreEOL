...
CKEDITOR.plugins.add( 'video',
{
	...
	init : function( editor )
	{
		...
		*/
		...
		editor.lang.fakeobjects.video = ttFakeObjectVideo;
...
var en = {
		toolbar	: ttToolbarVideo,
		dialogTitle : ttDialogTitleVideo,
		fakeObject : ttToolbarVideo,
		properties : ttPropertiesVideo,
		widthRequired : ttWidthRequiredVideo,
		heightRequired : ttHeightRequiredVideo,
		poster: ttPosterImageVideo,
		sourceVideo: ttsourceVideo,
		numberOfPlay: ttNumberOfPlaysVideo,
		numberOfPlayRequired: ttNumberOfPlayRequiredVideo,
		sourceType : ttVideoTypeVideo,
