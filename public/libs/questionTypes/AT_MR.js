 ...
 */
function deleteAnswer_MR(askConfirmation){
    if(((!askConfirmation) || (confirmDialog(ttWarning, ttCDeleteAnswer, deleteAnswer_MR, false)))){
        var idQuestion = questionsTable.row(questionRowSelected).data()[qtci.questionID];
...
function reloadAnswersTable(idNewQuestion, tableData){
    ...
    $("body").append($("#newAnswer_MR").parent());          // Move new answer button to save it
