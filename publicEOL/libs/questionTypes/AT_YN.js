 ...
 * Date: 24/09/14
 * Time: 19:35
 * Desc: Javascript actions for answer in Yes/No questions
 */
...
/**
 *  @name   saveAnswerInfo_YN
 *  @descr  Binded function to save Yes / No answer info
 *  @param  close       Boolean                     Close panel if true
 */
function saveAnswerInfo_YN(close){
