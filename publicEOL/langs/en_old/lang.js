...
var ttAnswer = "Answer";
var ttNotes = "Error Description";
var ttspiegazionerr = "P.S. If you want to report an error not related to a specific question, leave the ID Question field blank.";
var ttInvia = "Send";
...
var ttEExamsNotArchivedEditTestSettings = "The operation can not be completed, because these settings are used by at least one not archived exam.<br/>Only name and description will be updated. Continue?";
...
var ttMSubjectQuestions = "To manage topics and questions, please select the subject";
...
var ttReportTemplateDelete = "Template deleted";
...
var ttHelpExams="You can create a new test by clicking on the button at the top right, or view and correct the existing exams";
var ttHelpSubject="Select a subject from the list below to view the questions contained in it";
