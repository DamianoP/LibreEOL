...
class AT_PL extends Answer
{
    ...
    public function printAnswerInfoEditForm($action)
    {
        ...
        ?>
        <dl class="dropdownInfo scorePL tSpace right" id="answerScore">
    ...
    public function printSubEditForm($action)
    {
        global $config;
        ...
        $this->printSubTabsAndTextareas();
        ?>

        <div class="clearer bSpace"></div>

        <!-- Print all other answer's info -->
        <?php $this->printSubInfoEditForm($action) ?>

        <!-- Print buttons for answer panel -->
        <?php $this->printAnswerEditButtonsPL($action); ?>
    ...
    public function printSubInfoEditForm($action)
    {
        global $log;
